...
namespace Thomas {
    ...
    GLboolean
        Shader::FileExists(std::string const& file_name) {
    ...
    GLboolean
        Shader::CompileLinkValidate(std::vector<std::pair<GLenum, std::string>> vec) {
        for (auto& elem : vec) {
    ...
    GLboolean
        Shader::CompileShaderFromFile(GLenum shader_type, const std::string& file_name) {
    ...
    GLboolean
        Shader::CompileShaderFromString(GLenum shader_type,
