...
namespace Thomas
{
    Node::Node(bool pBlocked, Vec2 pPosition, int pGridX, int pGridY) : position{ 0,0 }, gridX{ pGridX }, gridY{ pGridY }, Gcost{ 0 }, Hcost{ 0 }, Fcost{ 0 }, blocked{ false }, previous{ nullptr }, neighbours{}
    {
        position = pPosition;
