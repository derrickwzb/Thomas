...
/*!
\file		Enemy.h
\author 	Derrick Woo / Keith Lua / Zhi Xiong
...
struct Enemy : Thomas::ScriptableEntity
{
	...
	void OnUpdate(Thomas::Timestep ts)
	{
		...
		if (g_IsPaused == false)
		{
			...
			// RANGE ENEMY ============================================================================================================
			if (GetComponent<Thomas::ObjectType>().type == Thomas::ObjectTypeID::enemyRanged && combat_data.health > 0)
			{
				// Right Movement
				...
				if (distanceToWaypoint <= 5)
				{
					...
					timeOfShot -= ts;
					text_data.set_Start = 7;
					text_data.set_End = 11;
					text_data.speed = 5.f;
					if (timeOfShot <= 0)
					{
